                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <form @submit.prevent="submit">
                        <div class="p-6 mt-4">
                            ...
                            <div class="mt-4">
                                <jet-label value="Halaman ini digunakan untuk menambahkan data anggota keluarga selain anak atau bayi. Dapat digunakan untuk mendaftarkan diri sendiri." />
                            </div>
                            <div class="mt-4">
