            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">   
                    <div class="p-6 mt-4">
                        ...
                        <div v-if="form.travelling == 'Ya'" class="mt-4">
                            ...
                            <div class="mt-2 flex">
                                ...
                                <jet-label class="pl-2" for="endemisj">Pergi atau tinggal di daerah endemis Japanese Ensephalitis</jet-label>
                            </div>
                            <div class="mt-2 flex">
                    ...
                    <div class="p-6 mt-4">
                        ...
                        <div class="mt-4">
                            <jet-label for="kondisi" class="font-semibold" value="Lingkungan Tempat Tinggal" />
                            <p class="text-xs my-3">Pilih kondisi yang sesuai dengan keadaan Anda, jika tidak ada kondisi yang memenuhi silahkan melanjutkan ke bagian berikutnya.</p>
                            <div class="mt-2 flex">
                            ...
                            <div class="mt-2 flex">
                                ...
                                <jet-label class="pl-2" for="hewan">Memiliki hewan anjing, kucing, kera yang dicurigai menderita rabies</jet-label>
                            </div>
                            <div class="mt-2 flex">
                                <input type="checkbox"  id="hiv" class="mt-1" v-model="form.kondisi" value="Petugas fasilitas kesehatan" /> 
                                <jet-label class="pl-2" for="hiv">Petugas fasilitas kesehatan, pengobatan HIV dan PMS</jet-label>
                            </div>
                            <div class="mt-2 flex">
                        ...
                        <div class="mt-4">
                            <jet-label for="imunisasisblm" class="font-semibold" value="Imunisasi Sebelumnya" />
                            <p class="text-xs my-3">Pilih imunisasi yang pernah diberikan sebelumnya, jika tidak ada klik tombol simpan untuk melanjutkan.</p>
