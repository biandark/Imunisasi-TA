<template>
    <div>
        <jet-banner />
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <div class="mt-4 relative">
                                    <jet-dropdown width="48">
                                        ...
                                        <template #content>
                                            <jet-dropdown-link :href="route('daftarimunisasi')" :active="route().current('daftarimunisasi')">
                                                Imunisasi Pilihan
                                            </jet-dropdown-link>
                                            <jet-dropdown-link :href="route('info')" :active="route().current('info')">
                                                Imunisasi Wajib
                                            </jet-dropdown-link>
                                ...
                                <div class="mt-4 relative">
                                    <jet-dropdown width="48">
                                        ...
                                        <template #content>
                                            <jet-dropdown-link :href="route('riwayat')" :active="route().current('riwayat')">
                                                Riwayat Imunisasi Pilihan
                                            </jet-dropdown-link>
                                            <jet-dropdown-link :href="route('riwayatwajib')" :active="route().current('riwayatwajib')">
            ...
            <!-- Page Footer -->
            <header class="bg-white shadow" v-if="$slots.footer">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
